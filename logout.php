...
/*
|--------------------------------------------------------------------------
| Decide Cancel button destination
|--------------------------------------------------------------------------
*/
...
if (isset($_SESSION['faculty_id'])) {
    ...
    $cancelPage = 'faculty_dashboard.php';

} elseif (isset($_SESSION['librarian_id'])) {

    // Librarian is logged in
    $cancelPage = 'librarian_dashboard.php';

} else {

    // Student is logged in
    $cancelPage = 'student_dashboard.php';
}
...
<main class="logout-page">
    ...
    <section class="logout-card"
        ...
        <form method="post" class="logout-actions">
            ...
            <!-- Cancel goes to the correct dashboard -->
            <a href="<?php echo htmlspecialchars($cancelPage); ?>">
                Cancel
            </a>
